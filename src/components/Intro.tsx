...
// Hero section (Step 2). Left-aligned name + bio + two CTAs, full width —
// the portrait column is commented out for now (see below).
function Intro() {
  return (
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-12">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="mt-5 max-w-prose text-base md:text-lg text-ink/70 dark:text-ink-dark/70">
            I'm an early-career software engineer with a background in math and statistics. Math brought me into computer science, 
            and the rapidly growing world of ML convinced me to pursue a second major in Statistics and do an advanced degree. I like to read the latest papers in AI and ML and I also build projects with and without AI in my free time.
          </p>
        ...
        {/* Right: 4:5 portrait — removed for now, swap back in during the content pass:
