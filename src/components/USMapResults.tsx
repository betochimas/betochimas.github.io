...
export const USMapResults = ({ currentMode, currentYear }: USMapResultsProps) => {
  ...
  // const onHoverUSAStateStrokeColor = "slate";
	...
	console.log("state_colors_t", state_colors_t[currentMode]?.[currentYear]);
	
	//const modeColors = state_colors[currentMode];
	//const yearColors = modeColors[currentYear] || {};
	const yearColors = state_colors_t[currentMode]?.[currentYear] || {};
  ...
  <svg
    ...
    viewBox="0 0 959 593"
    fill={"#999999"}
    className={twMerge("w-5/6 h-5/6 mx-auto", "")}
  >
  <g>
    <path
    	name="Alaska"
     	//className={twMerge("hover:cursor-pointer", `fill-${yearColors["Alaska"]} || 'fill-results-red'`)}
			 className={twMerge("hover:cursor-pointer", `fill-${yearColors["Alaska"]}`)}
    ...
    <path
     	name="Hawaii"
     	className={twMerge("hover:cursor-pointer", `fill-${yearColors["Hawaii"]}`)}
		...
		<path
			name="Alabama"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Alabama"]}`)}
    ...
    <path
    	name="Arkansas"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Arkansas"]}`)}
    ...
    <path
			name="Arizona"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Arizona"]}`)}
    ...
    <path
			name="California"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["California"]}`)}
    ...
    <path
			name="Colorado"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Colorado"]}`)}
    ...
    <path
			name="Connecticut"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Connecticut"]}`)}
    ...
    <path
			name="Delaware"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Delaware"]}`)}
    ...
    <path
     name="Florida"
		 className={twMerge("hover:cursor-pointer", `fill-${yearColors["Florida"]}`)}
    ...
    <path
			name="Georgia"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Georgia"]}`)}
    ...
    <path
			name="Iowa"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Iowa"]}`)}
    ...
    <path
			name="Idaho"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Idaho"]}`)}
    ...
    <path
			name="Illinois"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Illinois"]}`)}
    ...
    <path
			name="Indiana"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Indiana"]}`)}
    ...
    <path
			name="Kansas"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Kansas"]}`)}
    ...
    <path
			name="Kentucky"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Kentucky"]}`)}
    ...
    <path
			name="Louisiana"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Louisiana"]}`)}
    ...
    <path
			name="Massachusetts"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Massachusetts"]}`)}
    ...
    <path
			name="Maryland"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Maryland"]}`)}
    ...
    <path
			name="Maine"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Maine"]}`)}
    ...
    <path
			name="Michigan"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Michigan"]}`)}
    ...
    <path
			name="Minnesota"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Minnesota"]}`)}
    ...
    <path
			name="Missouri"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Missouri"]}`)}
    ...
    <path
			name="Mississippi"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Mississippi"]}`)}
    ...
    <path
			name="Montana"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Montana"]}`)}
    ...
    <path
			name="North Carolina"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["North Carolina"]}`)}
    ...
    <path
			name="North Dakota"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["North Dakota"]}`)}
    ...
    <path
			name="Nebraska"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Nebraska"]}`)}
    ...
    <path
			name="New Hampshire"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["New Hampshire"]}`)}
    ...
    <path
			name="New Jersey"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["New Jersey"]}`)}
    ...
    <path
			name="New Mexico"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["New Mexico"]}`)}
    ...
    <path
			name="Nevada"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Nevada"]}`)}
    ...
    <path
			name="New York"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["New York"]}`)}
    ...
    <path
     name="Ohio"
		 className={twMerge("hover:cursor-pointer", `fill-${yearColors["Ohio"]}`)}
    ...
    <path
			name="Oklahoma"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Oklahoma"]}`)}
    ...
    <path
			name="Oregon"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Oregon"]}`)}
    ...
    <path
			name="Pennsylvania"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Pennsylvania"]}`)}
    ...
    <path
			name="Rhode Island"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Rhode Island"]}`)}
    ...
    <path
			name="South Carolina"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["South Carolina"]}`)}
    ...
    <path
			name="South Dakota"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["South Dakota"]}`)}
    ...
    <path
			name="Tennessee"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Tennessee"]}`)}
    ...
    <path
			name="Texas"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Texas"]}`)}
    ...
    <path
			name="Utah"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Utah"]}`)}
    ...
    <path
			name="Virginia"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Virginia"]}`)}
    ...
    <path
			name="Vermont"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Vermont"]}`)}
    ...
    <path
			name="Washington"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Washington"]}`)}
    ...
    <path
			name="Wisconsin"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Wisconsin"]}`)}
    ...
    <path
			name="West Virginia"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["West Virginia"]}`)}
    ...
    <path
			name="Wyoming"
			className={twMerge("hover:cursor-pointer", `fill-${yearColors["Wyoming"]}`)}
    ...
    <g>
     ...
     <circle
      name="District of Columbia"
			//className={twMerge("hover:cursor-pointer", `fill-${yearColors["District of Columbia"]} || 'fill-results-blue'`)}
      className={twMerge("hover:cursor-pointer", `fill-${yearColors["District of Columbia"]}`)}
			stroke="#FFFFFF"
      strokeWidth="1.5"
      cx="801.3"
      cy="251.8"
